  ...
  })()(
    {
        ...
        function (require, module, exports) {
          ...
          module.exports = function (chai, _) {
            ...
            function assertLeast(n, msg) {
              ...
              if (!doLength && objType === 'date' && nType !== 'date') {
                errorMessage =
                  msgPrefix + 'the argument to least must be a date'
              } else if (
                nType !== 'number' &&
                (doLength || objType === 'number')
              ) {
                errorMessage =
                  msgPrefix + 'the argument to least must be a number'
              } else if (
                !doLength &&
                objType !== 'date' &&
                objType !== 'number'
            ...
            function assertBelow(n, msg) {
              ...
              if (!doLength && objType === 'date' && nType !== 'date') {
                errorMessage =
                  msgPrefix + 'the argument to below must be a date'
              } else if (
                nType !== 'number' &&
                (doLength || objType === 'number')
              ) {
            ...
            function assertMost(n, msg) {
              ...
              if (!doLength && objType === 'date' && nType !== 'date') {
                ...
                errorMessage =
                  msgPrefix + 'the argument to most must be a number'
              } else if (
                !doLength &&
                objType !== 'date' &&
                objType !== 'number'
            ...
            Assertion.addMethod('within', function (start, finish, msg) {
              ...
              if (
                ...
                errorMessage =
                  msgPrefix + 'the arguments to within must be dates'
              } else if (
                (startType !== 'number' || finishType !== 'number') &&
                (doLength || objType === 'number')
              ) {
                errorMessage =
                  msgPrefix + 'the arguments to within must be numbers'
              } else if (
                !doLength &&
                objType !== 'date' &&
                objType !== 'number'
            ...
            function closeTo(expected, delta, msg) {
              ...
              if (typeof expected !== 'number' || typeof delta !== 'number') {
                flagMsg = flagMsg ? flagMsg + ': ' : ''
                var deltaMessage =
                  delta === undefined ? ', and a delta is required' : ''
                throw new AssertionError(
                  flagMsg +
            ...
            function assertChanges(subject, prop, msg) {
              ...
              var final =
                prop === undefined || prop === null ? subject() : subject[prop]
              var msgObj =
                prop === undefined || prop === null ? initial : '.' + prop
      ...
      9: [
        function (require, module, exports) {
          ...
          var testFn = function () {}
          var excludeNames = Object.getOwnPropertyNames(testFn).filter(
            function (name) {
            ...
            var str = types
              .map(function (t, index) {
                var art = ~['a', 'e', 'i', 'o', 'u'].indexOf(t.charAt(0))
                  ...
                  : 'a'
                var or =
                  types.length > 1 && index === types.length - 1 ? 'or ' : ''
                return or + art + ' ' + t
              })
              .join(', ')
      ...
      23: [
        function (require, module, exports) {
          ...
          function inspect(obj, showHidden, depth, colors) {
            var options = {
              ...
              truncate: config.truncateThreshold
                ? config.truncateThreshold
                : Infinity
            }
        ...
        { '../config': 4, 'get-func-name': 36, loupe: 37 }
      ],
      24: [
        function (require, module, exports) {
          /*!
        ...
        function (require, module, exports) {
          ...
          module.exports = function overwriteChainableMethod(
            ...
            chainableBehavior.method =
              function overwritingChainableMethodWrapper() {
        ...
        function (require, module, exports) {
          ...
          function compatibleMessage(thrown, errMatcher) {
            var comparisonString =
              typeof thrown === 'string' ? thrown : thrown.message
          ...
          ;(function (global, factory) {
            ...
            function normaliseOptions() {
              var _ref =
                ...
                showHidden =
                  _ref$showHidden === void 0 ? false : _ref$showHidden,
                ...
                customInspect =
                  _ref$customInspect === void 0 ? true : _ref$customInspect,
                _ref$showProxy = _ref.showProxy,
                showProxy = _ref$showProxy === void 0 ? false : _ref$showProxy,
                _ref$maxArrayLength = _ref.maxArrayLength,
                maxArrayLength =
                  _ref$maxArrayLength === void 0
                    ? Infinity
                    : _ref$maxArrayLength,
                _ref$breakLength = _ref.breakLength,
                breakLength =
                  _ref$breakLength === void 0 ? Infinity : _ref$breakLength,
                _ref$seen = _ref.seen,
            ...
            function truncate(string, length) {
              ...
              if (stringLength > length && stringLength > tailLength) {
                return ''
                  .concat(string.slice(0, length - tailLength))
                  .concat(tail)
              }
            ...
            function inspectList(list, options, inspectItem) {
              ...
              for (var i = 0; i < size; i += 1) {
                ...
                peek = last
                  ? ''
                  : inspectItem(list[i + 1], options) +
                    (secondToLast ? '' : separator) // If we have one element left, but this element and
            ...
            function inspectArray(array, options) {
              ...
              if (nonIndexProperties.length) {
                propertyContents = inspectList(
                  nonIndexProperties.map(function (key) {
            ...
            function inspectTypedArray(array, options) {
              ...
              if (!array.length && !nonIndexProperties.length)
                return ''.concat(name, '[]') // As we know TypedArrays only contain Unsigned Integers, we can skip inspecting each one and simply
            ...
            function inspectDate(dateObject, options) {
              ...
              return options.stylize(
                ''
                  .concat(date, 'T')
                  .concat(
                    truncate(split[1], options.truncate - date.length - 1)
                  ),
                'date'
              )
            }
            ...
            function inspectFunction(func, options) {
              ...
              return options.stylize(
                '[Function '.concat(truncate(name, options.truncate - 11), ']'),
                'special'
              )
            }
            ...
            function inspectMap(map, options) {
              ...
              options.truncate -= 7
              return 'Map{ '.concat(
                inspectList(mapToEntries(map), options, inspectMapEntry),
                ' }'
              )
            }
            ...
            function inspectRegExp(value, options) {
              ...
              return options.stylize(
                '/'.concat(truncate(source, sourceLength), '/').concat(flags),
                'regexp'
              )
            }
            ...
            function inspectSet(set, options) {
              ...
              options.truncate -= 7
              return 'Set{ '.concat(
                inspectList(arrayFromSet(set), options),
                ' }'
              )
            }
            ...
            function inspectString(string, options) {
              ...
              return options.stylize(
                "'".concat(truncate(string, options.truncate - 2), "'"),
                'string'
              )
            }
            ...
            function inspectSymbol(value) {
              if ('description' in Symbol.prototype) {
                return value.description
                  ? 'Symbol('.concat(value.description, ')')
                  : 'Symbol()'
              }
            ...
            try {
              ...
              if (Array.isArray(getPromiseDetails(Promise.resolve()))) {
                getPromiseValue = function getPromiseValue(value, options) {
                  ...
                  return 'Promise'
                    .concat(state === kRejected ? '!' : '', '{')
                    .concat(options.inspect(innerValue, options), '}')
                }
              }
            } catch (notNode) {
              /* ignore */
            ...
            function inspectObject(object, options) {
              ...
              var propertyContents = inspectList(
              ...
              var symbolContents = inspectList(
            ...
            function inspectAttribute(_ref, options) {
              ...
              return ''
                ...
                .concat(options.stylize('"'.concat(value, '"'), 'string'))
            }
            ...
            function inspectHTML(element, options) {
              ...
              if (children && children.length > truncate) {
                children = ''
                  .concat(truncator, '(')
                  .concat(element.children.length, ')')
              }
            ...
            var chaiInspect = symbolsSupported
            ...
            var inspectCustom = function inspectCustom(value, options, type) {
              if (
                ...
                typeof value[chaiInspect] === 'function'
              ) {
              ...
              if (
                ...
                typeof value[nodeInspect] === 'function'
              ) {
      ...
      38: [
        function (require, module, exports) {
          ...
          function internalGetPathValue(obj, parsed, pathDepth) {
            ...
            var res = null
            pathDepth =
              typeof pathDepth === 'undefined' ? parsed.length : pathDepth
